...
export const ScrambleDraw = () => {
    ...
    const scrambleFaces = useMemo(() => drawScramble('R2'), [])
    ...
    return (
        <Card className="lg:col-span-2 p-5">
            ...
            >
                <div
                    className="bg-black col-start-2 grid grid-cols-3 gap-1 w-fit p-1"
                >
            ...
            <div className="mt-1 grid grid-cols-4 gap-1 w-fit">
                <div
                    className="bg-black grid grid-cols-3 gap-1 w-fit p-1"
                >
                    {
