        ...
        <Dialog>
            ...
            <DialogContent className="sm:max-w-[425px]">
                ...
                <form className="grid gap-4 py-5" onSubmit={onAddNewMethod}>
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        <Label className="text-right">Cube view</Label>
                        <Select
                            disabled={!cube}
                            value={cubeView}
                            onValueChange={setCubeView}
                        >
                            <SelectTrigger className="col-span-3">
                                <SelectValue placeholder="Select a cube view" />
                            </SelectTrigger>
                            <SelectContent>
                                <SelectItem value="top-view">
                                    top-view
                                </SelectItem>

                                <SelectItem value="full-view">
                                    full-view
                                </SelectItem>
                            </SelectContent>
                        </Select>
