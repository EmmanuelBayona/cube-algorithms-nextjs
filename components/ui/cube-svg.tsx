            ...
            <g style={{ opacity: 1, strokeOpacity: 0.5, strokeWidth: 0, strokeLinejoin: 'round' }}>
                {
                    CUBE_FACES.map((face, i) => (
                        <polygon
                            ...
                            // stroke={colors?.[i] ? CUBE_COLORS[colors[i]] : face.stroke}
                            // fill={face.fill}
                            stroke={face.stroke}
                            points={face.points}
                            // if clickableFaces is true, add a click event to the face
                            // if onClick is provided, call it with the face number
                            className={cn({
                                'cursor-pointer': clickableFaces, 
                            })}
                            // onClick={() => onClickFace?.(i + 1)}
